...
const SOCIALS = [
  ...
  { label: 'GitHub', value: 'github.com/emmanuelmaurice', href: 'https://github.com/emmanuelmaurice' },
  { label: 'LinkedIn', value: 'linkedin.com/in/emmanuelmaurice', href: 'https://linkedin.com/in/emmanuelmaurice' },
  { label: 'X / Twitter', value: 'x.com/emmanuelmaurice', href: 'https://x.com/emmanuelmaurice' },
]
...
function ContactForm() {
  ...
  const fieldStyle = (key) => ({
    ...
    padding: '14px 0',
    border: 0,
    borderBottom: '1px solid ' + (focus === key ? 'var(--accent-1)' : 'var(--line-strong)'),
...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <Reveal delay={120}>
        <a
          href="mailto:hello@emmanuelmaurice.dev"
          className="big-cta"
          style={{
            display: 'block',
            fontFamily: 'var(--font-sans)',
      ...
      <div className="contact-grid" style={{
        ...
        <Reveal delay={200}>
          <div>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: 11, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--ink-mute)', marginBottom: 20 }}>
              Currently
            </div>
            <p style={{ margin: 0, fontSize: 'clamp(18px, 2vw, 22px)', lineHeight: 1.5, color: 'var(--ink)', maxWidth: 520 }}>
        ...
        <Reveal delay={280}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            {SOCIALS.map(s => (
              ...
              >
                <span style={{ color: 'var(--ink-mute)', fontSize: 11, letterSpacing: '0.06em', textTransform: 'uppercase' }}>
                  {s.label}
                </span>
