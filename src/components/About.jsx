...
export default function About() {
  return (
    <section id="about" style={{ padding: 'clamp(80px, 12vw, 160px) 24px', maxWidth: 1280, margin: '0 auto' }}>
      ...
      <div className="about-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: 64, alignItems: 'start' }}>
        ...
        <div>
          <Reveal delay={140}>
            <p style={{
              ...
              <br />
              transitioning from reading scripts to writing syntax, and surfing the world of AI to learn how it makes work easier and faster.
            </p>
          </Reveal>

          <Reveal delay={220}>
            <p style={{ margin: '0 0 48px', fontSize: 16, lineHeight: 1.6, color: 'var(--ink-soft)', maxWidth: 620 }}>
